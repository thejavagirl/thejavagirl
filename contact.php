...
$fields = array('username' => 'Username:', 'name' => 'Name:', 'email' => 'Email:', 'phone' => 'Phone:', 'service'  => 'Service:', 'method' => 'Contact_method:', 'message' => 'Message:');
...
if($spam) {  // If the hidden field is not empty, it's a bot
    ...
    try
    {
        ...
        $emailTextHtml .= "<h3>New message from the The Java Girl:</h3><hr>";
        $emailTextHtml .= "<table>";
        ...
        $emailTextHtml .= "<p>Have a great day!<br><br>Sincerely,<br><br>TheJavaGirl.com</p>";
